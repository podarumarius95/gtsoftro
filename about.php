...
<!-- PAGE TITLE -->
<section id="page-title" class="page-title-parallax text-light" data-stellar-background-ratio="0.9" style="background-image: url(images/parallax/about.png)">
...
<section class="background-grey">
	<div class="container">
		<div class="heading heading-center">
			<h2>OUR TEAM</h2>
			<span class="lead">We are the best beacause we work with the best people.</span>
		</div>
				<div class="row">
			<div class="col-md-3">
				...
				<div class="image-box-description text-center">
					...
					<hr class="line">
					<div>Vlad leads the company’s software product development efforts with a focus on quality in order to maintain GTSoft’s long track record of customer satisfaction.</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="image-box circle-image small">
				...
				<div class="image-box-description text-center">
					...
					<hr class="line">
					<div>Andu has created e-commerce systems from scratch as well as integrated off-the-shelf solutions. He is an expert in web technologies and mobile development.</div>
			...
			<div class="col-md-3">
				...
				<div class="image-box-description text-center ">
					...
					<p class="subtitle">Software Developer</p>
					<hr class="line">
					<div><b>Dorian</b> develops custom web applications, integrates and extends third-party systems, develops advanced solutions and he rides his motorcycle on his way to work.</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="image-box circle-image small">
				...
				<div class="image-box-description text-center">
					...
					<p class="subtitle">SEO & Marketing Manager</p>
					<hr class="line">
					<div><b>Madalina</b> was a key addition to our team in 2017, at a time when the race for social media dominance came to the forefront of software and web development.</div>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-3">
				...
				<div class="image-box-description text-center">
					...
					<hr class="line">
					<div>Marius is the founder of GTSoft. He has over 10 years of design and web development experience and built his first Web site (complete with custom CMS) in 2007. </div>
				</div>
			</div>
					<div class="heading heading-center">
					<section>
			<h2>Want to be the next member?</h2>
			<span class="lead">We are hiring. Build your future career at GTSoft.</span><br><BR><br>
			<span class="lead" ><a href="#" class="button black-light button-3d rounded icon-left"><span><i class="fa fa-cloud"></i>See availabale jobs here</span></a></span></section>
		</div>
		</div>
	</div>
</section>
